...
public class lobby extends server {
    ...
    private static CopyOnWriteArrayList<String> Users = new CopyOnWriteArrayList<String>();
    private static final Map<String, String> UserInput = new ConcurrentHashMap<>();
    private static AtomicBoolean SequentialInput = new AtomicBoolean(false);
    private static AtomicBoolean LobbyLocked = new AtomicBoolean(false);
    ...
    public void sendMessage(String UserName, String Message) {
        ...
        synchronized (SequentialInput) {
            if (SequentialInput.get()) {
    ...
    static class Hangman implements Runnable {
        public void run() {
            ...
            Map<String, String> UserInputCompare = new ConcurrentHashMap<>();
